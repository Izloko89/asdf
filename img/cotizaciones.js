...
$(document).ready(function(e) {
	...
	$( ".cliente_cotizacion" ).autocomplete({
      ...
      select: function( event, ui ) {
		...
		$("#cotizaciones #ncom").val(ui.item.ncom);
		$("#cotizaciones #titulo").val(ui.item.titulo);
	  }
    });
	...
	$.ajax({
	  ...
	  success: function(r){
		...
		if(r.bool){
			...
			$("#cotizaciones #ncom").val(r.ncom);
			$("#cotizaciones #titulo").val(r.titulo);
			...
			document.getElementById("imp_cot1").setAttribute("href", "scripts/pdf_cotizacion2.php?id=" + cotizacion);
